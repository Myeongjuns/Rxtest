...
import com.gmail.blackbull8810.test01.Retrofit2.MultipleResource;
import com.gmail.blackbull8810.test01.Retrofit2.User;
import com.gmail.blackbull8810.test01.Retrofit2.UserList;
...
/**
        ...
        call1.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                responseText2.setText(user1.name + " " + user1.job + " " + user1.id + " " + user1.createdAt);
            }
...
/**
        ...
        Call<UserList> call2 = apiInterface.doGetUserList("5");
